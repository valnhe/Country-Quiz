export function doQuestion (countries) {
    ...
    const allQuestion = [firstQuestion, secondQuestion, thirdQuestion, fourthQuestion, sixthQuestion, seventhQuestion, eighthQuestion, ninthQuestion, ninthQuestion, ninthQuestion];
